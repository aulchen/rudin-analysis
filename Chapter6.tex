...
\begin{proof}
It suffices to show that $\lim_{n\rightarrow\infty} \sqrt{n+1} - \sqrt{n} = 0$. By a Taylor expansion around $n$,

\begin{align*}
\sqrt{n+1} &= \sqrt{n} + \frac{1}{2(1!)} n^{-\frac{1}{2}} 
- \frac{1}{2^2(2!)} n^{-\frac{3}{2}}
+ \frac{3}{2^3(3!)} n^{-\frac{5}{2}} \dots \\
&= \sqrt{n} + \sum_{i=1}^{\infty} \frac{(-1)^{i-1}}{2^i} \frac{1(3)(5)...(2i-1)}{i!} n^{-i + \frac{1}{2}}
\end{align*}
\end{proof}
